...
!(function(a, b, c, d) {
  ...
  var e = "parallaxify",
    ...
    i = function(a, b) {
      return 1 / (1 + Math.exp(-(0.07056 * b * (3 ^ a)) - 1.5976 * b * a));
    },
    j = function(a, b, c) {
      return null === b
        ? a
        : ("undefined" == typeof c && (c = 0.5), c * a + (1 - c) * b);
    },
    k = [],
    l = {
      linear: function(a, b) {
      ...
      natural: function(a, b) {
        return a <= -b
          ...
          : a >= b
            ? -1
            : (k["n" + b] === d && (k["n" + b] = Math.tan(0.01745 * b)),
              -Math.tan(0.01745 * a) / k["n" + b]);
      },
      performance: function(a, b) {
        return a <= -b
          ...
          : a >= b
            ? -1
            : (k["p" + b] === d &&
                (k["p" + b] = b / 90 + 4.2 * Math.pow(b / 90, 7)),
              -(a / 90 + 4.2 * Math.pow(a / 90, 7)) / k["p" + b]);
      },
      gaussian: function(a, b) {
        return 1 - 2 * i(a / 90, 135 / b);
      }
    },
    m = (function() {
      var e,
  ...
  (s.prototype = {
    ...
    _defineElements: function() {
      (this.$element = a(
        this.element === c.body || this.element === b ? "body" : this.element
      )),
        (this.$viewportElement = a(b));
    },
    _defineGetters: function() {
      var a = this,
        b = l[a.options.motionType],
        c = l[a.options.mouseMotionType];
      (this._getMoveHorizontal = function() {
        ...
        if (this.useSensor && null !== this.beta && null !== this.gamma) {
          ...
          return this.viewportLandscape
            ? this.viewportFlipped
              ? b(-a.beta, this.options.motionAngleX)
              : b(a.beta, this.options.motionAngleX)
            : this.viewportFlipped
              ? b(-a.gamma, this.options.motionAngleX)
              : b(a.gamma, this.options.motionAngleX);
        }
        return (
          (this.useSensor = !1),
        ...
        (this._getMoveVertical = function() {
          ...
          if (this.useSensor && null !== this.beta && null !== this.gamma) {
            ...
            return this.viewportLandscape
              ? this.viewportFlipped
                ? b(-a.gamma, this.options.motionAngleY)
                : b(a.gamma, this.options.motionAngleY)
              : this.viewportFlipped
                ? b(-a.beta, this.options.motionAngleY)
                : b(a.beta, this.options.motionAngleY);
          }
          return (
            (this.useSensor = !1),
    ...
    _defineSetters: function() {
      var a = this,
        b = h[a.options.positionProperty];
      this._setPosition =
        b.setPosition ||
        function(c, d, e, f, g) {
          a.options.horizontalParallax && b.setLeft(c, d, e),
            a.options.verticalParallax && b.setTop(c, f, g);
        };
    },
    refresh: function(c) {
      (c && c.firstLoad) || this._reset(),
        ...
        c &&
          ...
          a(b).on("load", function() {
            var b = a("body");
            (oldLeft = b.scrollLeft()),
              (oldTop = b.scrollTop()),
              b.scrollLeft(oldLeft + 1),
              b.scrollTop(oldTop + 1),
              b.scrollLeft(oldLeft),
              b.scrollTop(oldTop);
          });
    },
    _detectViewport: function() {
      (this.viewportWidth = this.$viewportElement.width()),
        ...
        this.useSensor &&
          ((this.viewportFlipped = 180 === b.orientation),
          (this.viewportLandscape = 90 === Math.abs(b.orientation)));
    },
    ...
    _detectMotionType: function() {
      (this.useSensor = !1),
        ...
        this.options.useGyroscope &&
          ...
          ((this.useSensorWebkit = b.DeviceOrientationEvent !== d),
          (this.useSensorMoz = b.OrientationEvent !== d),
      ...
      (this.elements = []),
        this.options.parallaxElements &&
          this.$element
            ...
            .each(function(c) {
              var e = a(this);
              if (e.data("parallaxify-ElementIsActive")) {
                if (e.data("parallaxify-ElementIsActive") !== this) return;
              } else e.data("parallaxify-ElementIsActive", this);
              e.data("parralaxify-originalLeft")
                ? (e.css("left", e.data("parallaxify-originalLeft")),
                  e.css("top", e.data("parallaxify-originalTop")))
                : (e.data("parallaxify-originalLeft", e.css("left")),
                  e.data("parallaxify-originalTop", e.css("top"))),
                b.elements.push({
                  $element: e,
                  originalPositionLeft: e.position().left,
                  originalPositionTop: e.position().top,
                  parallaxDistanceX:
                    e.data("parallaxify-range-x") !== d
                      ? e.data("parallaxify-range-x")
                      : e.data("parallaxify-range") !== d
                        ? e.data("parallaxify-range")
                        : 0,
                  parallaxDistanceY:
                    e.data("parallaxify-range-y") !== d
                      ? e.data("parallaxify-range-y")
                      : e.data("parallaxify-range") !== d
                        ? e.data("parallaxify-range")
                        : 0,
      ...
      (this.backgrounds = []),
        this.options.parallaxBackgrounds &&
          ...
          c.each(function() {
            var c = a(this),
              e = q(c);
            if (c.data("parallaxify-backgroundIsActive")) {
              if (c.data("parallaxify-backgroundIsActive") !== this) return;
            } else c.data("parallaxify-backgroundIsActive", this);
            c.data("parralaxify-backgroundOriginalLeft")
              ? p(
                  c,
                  c.data("parallaxify-backgroundOriginalLeft"),
                  c.data("parallaxify-backgroundOriginalTop")
                )
              : (c.data("parallaxify-backgroundOriginalLeft", e[0]),
                c.data("parallaxify-backgroundOriginalTop", e[1])),
              b.backgrounds.push({
                $element: c,
                originalValueLeft: e[0],
                originalValueTop: e[1],
                originalBackgroundPositionLeft: isNaN(parseInt(e[0], 10))
                  ? 0
                  : parseInt(e[0], 10),
                originalBackgroundPositionTop: isNaN(parseInt(e[1], 10))
                  ? 0
                  : parseInt(e[1], 10),
                originalPositionLeft: c.position().left,
                originalPositionTop: c.position().top,
                parallaxDistanceX:
                  c.data("parallaxify-background-range-x") !== d
                    ? c.data("parallaxify-background-range-x")
                    : c.data("parallaxify-background-range") !== d
                      ? c.data("parallaxify-background-range")
                      : 0,
                parallaxDistanceY:
                  c.data("parallaxify-background-range-y") !== d
                    ? c.data("parallaxify-background-range-y")
                    : c.data("parallaxify-background-range") !== d
                      ? c.data("parallaxify-background-range")
                      : 0
              });
    ...
    _reset: function() {
      ...
      for (e = this.elements.length - 1; e >= 0; e--)
        (a = this.elements[e]),
          (b = a.$element.data("parallaxify-originalLeft")),
          (c = a.$element.data("parallaxify-originalTop")),
      ...
      for (e = this.backgrounds.length - 1; e >= 0; e--)
        (d = this.backgrounds[e]),
          d.$element
            ...
            .data("parallaxify-backgroundIsActive", null),
          p(d.$element, d.originalValueLeft, d.originalValueTop);
    },
    destroy: function() {
      this._reset(),
        this.useMouseMove &&
        ...
        this.useSensorMoz &&
          b.removeEventListener("MozOrientation", this._handleSensorMoz, !1),
        a(b)
    ...
    _processSensorData: function() {
      if (this.useSensor) {
        ...
        a > 90 && (a -= 180),
          ...
          (c = this.initialBeta !== d ? a - this.initialBeta : a),
          (e = this.initialGamma !== d ? b - this.initialGamma : b),
          c > 100 ? (c -= 180) : c < -100 && (c += 180),
          e > 200 ? (e -= 360) : e < -200 && (e += 360),
          (c = j(c, this.tilt.beta, this.options.alphaFilter)),
    ...
    _repositionElements: function() {
      var c,
        ...
        h,
        i,
        a = this._getMoveHorizontal(),
        b = this._getMoveVertical();
      if (
        this.currentMoveHorizontal !== a ||
        this.currentMoveVertical !== b ||
        ...
        for (
          ...
          (c = this.elements[i]),
            (g = this.options.horizontalParallax
              ? Math.floor(a * c.parallaxDistanceX / 2) + c.originalPositionLeft
              : c.originalPositionLeft),
            (h = this.options.verticalParallax
              ? Math.floor(b * c.parallaxDistanceY / 2) + c.originalPositionTop
              : c.originalPositionTop),
            this._setPosition(
              c.$element,
              g,
              c.originalPositionLeft,
        ...
        for (i = this.backgrounds.length - 1; i >= 0; i--)
          (d = this.backgrounds[i]),
            (e = this.options.horizontalParallax
              ? Math.floor(a * d.parallaxDistanceX / 2) +
                d.originalBackgroundPositionLeft +
                "px"
              : d.originalValueLeft),
            (f = this.options.verticalParallax
              ? Math.floor(b * d.parallaxDistanceY / 2) +
                d.originalBackgroundPositionTop +
                "px"
              : d.originalValueTop),
            p(d.$element, e, f);
      }
    ...
    _startAnimation: function() {
      ...
      (this._handleSensorWebkit = function(b) {
        ...
        (this._handleSensorMoz = function(b) {
          (a.gamma = 180 * b.x), (a.beta = b.y * -90), f();
        }),
        ...
        this.useSensorWebkit
          ? b.addEventListener("deviceorientation", a._handleSensorWebkit, !1)
          : this.useSensorMoz &&
            b.addEventListener("MozOrientation", a._handleSensorMoz, !1),
        this.useMouseMove &&
      ...
      return b === d || "object" == typeof b
        ? this.each(function() {
            a.data(this, "plugin_" + e) ||
              a.data(this, "plugin_" + e, new s(this, b));
          })
    ...
    (a[e] = function(c) {
      var d = a(b);
      return d[e].apply(d, Array.prototype.slice.call(arguments, 0));
    }),
